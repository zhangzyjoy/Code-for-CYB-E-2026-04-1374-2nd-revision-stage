...
%% Based on the IEEE TCYB (2025) paper:
%% <Distributed Extended State Observer-Based Formation Control of Flight Vehicles
%% Subject to Constraints on Speed and Acceleration>

%% Run <init_tcyb_2025_obs.m> to initialize the parameters and system states
%% Run <sim_tcyb_2025_obs.slx> to execute the formation control simulation
%% Run <plot_tcyb_2025_obs.m> to plot the simulation results
...
%% Parameter settings for distributed observer
