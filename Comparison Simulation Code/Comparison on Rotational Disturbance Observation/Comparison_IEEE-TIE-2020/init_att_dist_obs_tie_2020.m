...
%% Based on the IEEE TIE (2020) paper:
%% <Composite Disturbance Rejection Attitude Control
%% for Quadrotors With Unknown Disturbances>

%% Run <init_att_dist_obs_tie_2020.m> to initialize the parameters and system states
%% Run <sim_att_dist_obs_tie_2020.slx> to execute the attitude control simulation
%% Run <plot_att_dist_obs_tie_2020.m> to plot the simulation results
...
%% Parameter settings for disturbance observer in Rotational channel
