%% Plot result for IEEE TIE (2025) paper:
%% <Fixed-Time Angle Tracking Control for Multi-DOF Manipulators
%% Driven by Pneumatic Artificial Muscles>

%% Run <init_att_dist_obs_tie_2025.m> to initialize the parameters and system states
%% Run <sim_att_dist_obs_tie_2025.slx> to execute the attitude control simulation
%% Run <plot_att_dist_obs_tie_2025.m> to plot the simulation results
