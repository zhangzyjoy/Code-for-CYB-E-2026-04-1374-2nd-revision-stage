...
%%%% Compute the attitude angular velocity wc and the attitude angular acceleration dwc.
%%%% Refer to Zou et al., IJC, 2016:
%%%% "Nonlinear Hierarchical Control for Quad-Rotors with Rotation Matrix."
%%%% Alternatively, refer to Zou et al., IEEE TCYB, 2022:
