%% Comparative method for the translational control channel
%% Distributed observer for estimating the desired positions of followers
%% + External disturbance observer

%% The controller is designed with reference to the IEEE TCYB (2024) paper:
%% <Distributed Active Disturbance Rejection Formation Tracking Control for Quadrotor UAVs>

%% Run <init_tcyb_2024_pos_ctrl.m> to initialize parameters and system states
%% Run <sim_tcyb_2024_pos_ctrl.slx> to execute the formation control simulation
%% Run <plot_tcyb_2024_pos_ctrl.m> to plot the simulation results
...
%% Parameter settings for Distributed Formation Tracking Controller & Adaptive Laws

rho_p = [0.1; 0.1; 0.1];
tau_p = 5;
c_psi_p = [0.05; 0.05; 0.05];
