...
%% The controller is designed with reference to the IEEE TNSE (2024) paper:
%% <Saturated Distributed Centroid Tracking Control of Cluster Formation and Its Application to VTOL AAVs>

%% Run <init_tnse_2024_pos_ctrl.m> to initialize parameters and system states
%% Run <sim_tnse_2024_pos_ctrl.slx> to load the simulation model
%% Run <plot_tnse_2024_pos_ctrl.m> to plot the simulation results of the
...
%% Parameter settings for Saturated Distributed Observer
...
%% Parameter settings for Saturated Distributed Controller

c1 = diag( [ 150.0, 120.0, 120.0 ] );
c2 = diag( [ 80.0, 50.0, 50.0 ] );
sat_sr_up = [30, 30, 30];
sat_sr_low = [-30, -30, -30];
