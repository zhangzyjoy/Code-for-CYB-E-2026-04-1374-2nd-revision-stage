...
%% Run <sim_tvt_2025_pos_ctrl.slx> to execute the formation control simulation
%% Run <plot_tvt_2025_pos_ctrl.m> to plot the simulation results
...
%% Parameter settings for Leader Acceleration State Distributed observer
...
%% Parameter settings for Distributed Event-triggered Formation Controller
...
pos_bar_init = zeros(3,NF);
vel_bar_init = zeros(3,NF);
beta_init = zeros(3,NF);
d_beta_init = zeros(3,NF);
eta_ld_hat_init = zeros(3,NF);
ksi_ld_hat_init = zeros(3,NF);
