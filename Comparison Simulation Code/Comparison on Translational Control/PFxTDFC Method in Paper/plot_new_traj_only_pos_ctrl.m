%% Numerical simulation of the translational controller proposed in the paper
%% Run <init_new_traj_only_pos_ctrl.m> for parameter and state initialization
%% Run <sim_new_traj_only_pos_ctrl.slx> to execute the formation control simulation
%% Run <plot_new_traj_only_pos_ctrl.m> for visualization of the simulation results
...
%% Auxiliary velocity tracking control term for disturbance observation
kk_plot_disturb = 1;
kk_gain = 10;
...
%% Comparison between true and estimated auxiliary velocity tracking errors
