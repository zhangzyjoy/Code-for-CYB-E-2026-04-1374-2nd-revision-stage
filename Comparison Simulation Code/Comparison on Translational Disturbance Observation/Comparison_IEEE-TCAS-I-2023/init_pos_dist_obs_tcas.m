%% Comparative disturbance observer for the translational dynamics
%% Based on the IEEE TCAS-I (2023) paper:
%% <Composite Nonlinear Extended State Observer-Based Trajectory Tracking
%% Control for Quadrotors Under Input Constraints>

%% Run <init_pos_dist_obs_tcas.m> to initialize the parameters and system states
%% Run <sim_pos_dist_obs_tcas.slx> to load and execute the simulation model
%% Run <plot_pos_dist_obs_tcas.m> to plot the simulation results
