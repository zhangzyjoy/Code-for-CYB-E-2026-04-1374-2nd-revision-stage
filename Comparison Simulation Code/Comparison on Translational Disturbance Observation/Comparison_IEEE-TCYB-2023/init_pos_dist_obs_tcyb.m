%% Translational dynamics disturbance observer : comparative method
%% Based on the IEEE TCYB (2023) paper:
%% <Practical Predefined-Time Output-Feedback 
%% Consensus Tracking Control for Multiagent Systems>

%% Run <init_pos_dist_obs_tcyb.m> to initialize the parameters and system states
%% Run <sim_pos_dist_obs_tcyb.slx> to load and execute the simulation model
%% Run <plot_pos_dist_obs_tcyb.m> to plot the simulation results
