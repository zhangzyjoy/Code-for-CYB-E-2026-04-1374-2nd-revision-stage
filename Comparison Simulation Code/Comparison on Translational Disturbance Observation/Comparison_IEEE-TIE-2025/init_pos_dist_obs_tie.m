...
%% Based on the IEEE TIE (2025) paper:
%% <Fixed-Time Formation-Containment of Nonlinear Systems
%% Using Intermittent Output and Connectivity>
%% Run <init_pos_dist_obs_tie.m> to initialize the parameters and system states
%% Run <sim_pos_dist_obs_tie.slx> to load and execute the simulation model
%% Run <plot_pos_dist_obs_tie.m> to plot the simulation results
