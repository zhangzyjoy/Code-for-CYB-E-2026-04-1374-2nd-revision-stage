...
Take the derivatives for $\varsigma _{ 0 } ( t )$ and $\varsigma _{ 0 } ( t _{ f } - t )$. When $t \le 0$ holds, $\dot { \varsigma } _{ 0 } = 0$ and $\dot { \varsigma } ( t _{ f } - t ) = - \varsigma _{ 0 } ( t _{ f } - t ) / { ( t _{ f } - t ) } ^{ 2 }$ are yielded. When $0 < t < t _{ f }$ holds, it can be derived that $\dot { \varsigma } ( t ) = \frac { 1 } { t ^2 } e ^{ 1 / t } = \frac { 1 } { t ^2 } \varsigma _{ 0 } ( t )$ and $\dot { \varsigma } ( t _{ f } - t ) = - \frac { 1 } { { ( t _{ f } - t ) } ^2 } e ^{ - 1 / ( t _{ f } - t ) } = - \frac { 1 } { { ( t _{ f } - t ) } ^2 } \varsigma _{ 0 } ( t _{ f } - t )$ hold. When $t \ge t _{ f }$, the derivatives are yielded as $\dot { \varsigma } _{ 0 } ( t ) = \frac { 1 } { t ^{ 2 } } e ^{ 1 / t } = \frac { 1 } { t ^{ 2 } } { \varsigma } _{ 0 } ( t )$ and $\dot { \varsigma } _0 ( t _{ f } - t ) = 0$.
