...
The folder < ***Experimental Validation Code*** > and < ***Proposed Method Simulation Code*** > contains the validation source code in Python 3 / ROS 1 environment and simulation source code in Matlab/Simulink environment of the proposed control scheme, respectively. <br/>
...
**The five main sections listed below are divided into several markdown files < README - Part X - 1 .md > ~ < README - Part X - 3 .md >, respectively.** The corresponding markdown files in the folder < ***Theories and Validation README instructions*** > are depicted that < ***README - Part X - 1 .md*** > refers to the theoretical controller design for system stability, < ***README - Part X - 2 .md*** > refers to the control deployment procedure and parameter tuning principles based on the Lyapunov stability and performance metrices, < ***README - Part X - 3 .md*** > refers to the demonstration of the comparison results. <br/>
