...
This link indicates the proposed control approach for a formation control issue of uncrewed aerial vehicle (UAV) teams, where each quadcopter UAV node is decoupled into rotational and translational subsystems, respectively.<br/><br/> 
In the proposed method, a distributed practical fixed-time distributed formation controller (PFxTDFC) is established for the consensus in translational subsystem.<br/> 
